...
import {
  Alert, AsyncStorage, BackHandler, FlatList, Platform, ScrollView,
...
function DecisionStackScreen() {
  return (
    <restaurantStack.Navigator >
      <restaurantStack.Screen name="ListScreen" component={ListScreen} />
      <restaurantStack.Screen name="AddScreen" component={AddScreen} />
    </restaurantStack.Navigator>
  );
}

export default DecisionStackScreen
