 ...
 * #############################################################################
 */
 restaurantStack = createNativeStackNavigator()

 function DecisonStackScreen() {
   return (
     <restaurantStack.Navigator >
       <restaurantStack.Screen name="ListScreen" component={DecisionTimeScreen} />
       <restaurantStack.Screen name="AddScreen" component={WhosGoingScreen} />
       <restaurantStack.Screen name="AddScreen" component={PreFiltersScreen} />
       <restaurantStack.Screen name="AddScreen" component={ChoiceScreen} />
       <restaurantStack.Screen name="AddScreen" component={PostChoiceScreen} />
     </restaurantStack.Navigator>
   );
 }
 
 export default DecisonStackScreen;
